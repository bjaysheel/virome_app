...
internal class _Super_User extends com.adobe.fiber.services.wrapper.RemoteObjectServiceWrapper
{
    ...
    public function _Super_User()
    {
        ...
        operation = new mx.rpc.remoting.Operation(null, "RetrievePassword");
         operation.resultType = Boolean;
        operations["RetrievePassword"] = operation;
        ...
        _serviceControl.source = "cfc.User";
    ...
    /**
      * This method is a generated wrapper used to call the 'RetrievePassword' operation. It returns an mx.rpc.AsyncToken whose 
      ...
      */
    public function RetrievePassword(obj:Object) : mx.rpc.AsyncToken
    {
        var _internal_operation:mx.rpc.AbstractOperation = _serviceControl.getOperation("RetrievePassword");
