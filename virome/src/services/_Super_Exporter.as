...
internal class _Super_Exporter extends com.adobe.fiber.services.wrapper.RemoteObjectServiceWrapper
{
    ...
    public function _Super_Exporter()
    {
        ...
        _serviceControl.source = "VIROME.cfc.Exporter";
    ...
    /**
      ...
      */
    public function export(fileObject:Object, searchDBObject:Object, bin:ByteArray, content:String) : mx.rpc.AsyncToken
    {
        var _internal_operation:mx.rpc.AbstractOperation = _serviceControl.getOperation("export");
		var _internal_token:mx.rpc.AsyncToken = _internal_operation.send(fileObject,searchDBObject,bin,content) ;
