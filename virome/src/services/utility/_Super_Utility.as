...
internal class _Super_Utility extends com.adobe.fiber.services.wrapper.RemoteObjectServiceWrapper
{
    ...
    public function _Super_Utility()
    {
        ...
        operation = new mx.rpc.remoting.Operation(null, "reportFlexError");
        operations["reportFlexError"] = operation;
        ...
        _serviceControl.source = "cfc.Utility";
    ...
    /**
      * This method is a generated wrapper used to call the 'reportFlexError' operation. It returns an mx.rpc.AsyncToken whose 
      ...
      */
    public function reportFlexError(msg:String) : mx.rpc.AsyncToken
    {
        var _internal_operation:mx.rpc.AbstractOperation = _serviceControl.getOperation("reportFlexError");
		var _internal_token:mx.rpc.AsyncToken = _internal_operation.send(msg) ;
