 ...
 * of this service wrapper you may modify the generated sub-class of this class - ExportImage.as.
 */
package services
{
...
[ExcludeClass]
internal class _Super_ExportImage extends com.adobe.fiber.services.wrapper.RemoteObjectServiceWrapper
{

    // Constructor
    public function _Super_ExportImage()
    {
        ...
        _serviceControl.source = "VIROME.cfc.ExportImage";
    ...
    /**
      ...
      */
    public function saveImage(data:ByteArray) : mx.rpc.AsyncToken
    {
    ...
    /**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function savePDF(data:ByteArray) : mx.rpc.AsyncToken
    {
