package com
{
	...
	public class DataGridUtils
	{
		...
		private static var _util:MyUtility=new MyUtility();
		...
		public static function loadDataGridInExcel( dataGrid:DataGrid ):String 
		{
			...
			//ro.source = "cfc.SearchRPC";
			//ro.exportCSV(variables.htmlTable);
			//ro.addEventListener(FaultEvent.FAULT,_util.faultHandler);
			//ro.addEventListener(ResultEvent.RESULT,testInput);
		...
		public static function testInput(event:ResultEvent):void{
